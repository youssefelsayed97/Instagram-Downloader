...
def _get_config_dir() -> str:
    if platform.system() == "Windows":
        ...
        return os.path.join(tempfile.gettempdir(), ".packages-" + getpass.getuser())
    # on Unix, use ~/.config/packages
    return os.path.join(os.getenv("XDG_CONFIG_HOME", os.path.expanduser("~/.config")), "packages")
...
def get_legacy_session_filename(username: str) -> str:
    ...
    dirname = tempfile.gettempdir() + "/" + ".packages-" + getpass.getuser()
